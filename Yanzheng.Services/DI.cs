...
using Yanzheng.Data;     // Reference your DbContext project
using Yanzheng.Identity; // Reference your User entity project
...
namespace Microsoft.Extensions.DependencyInjection; // Extension methods usually live in this namespace


public static class IdentityServiceCollectionExtensions
{
    public static IServiceCollection AddYanzhengDependencies(this IServiceCollection services, IConfiguration configuration)
    {
